...
-- v2.194.0 by replaying its migrations and dumping the result. Do not
...
CREATE TABLE IF NOT EXISTS auth.identities (
    provider_id text CONSTRAINT identities_id_not_null NOT NULL,
    ...
    id uuid DEFAULT gen_random_uuid() CONSTRAINT identities_id_not_null1 NOT NULL
);
