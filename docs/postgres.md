...
The window defaults to a day and must exceed the longest fold upload and the gap between reading a manifest and publishing a branch from it, and one gc job runs at a time.
