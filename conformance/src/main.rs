...
//! marketing. So the suites here are questions, not expectations, and
//! the expectations are recordings of what PostgREST and GoTrue
//! actually answered, taken from the versions pinned in versions.json.
//!
